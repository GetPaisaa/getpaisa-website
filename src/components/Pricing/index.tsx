        ...
        <Slider {...settings}>
          ...
          <div className="w-full px-4 md:w-1/3 lg:w-1/4">
            ...
            >
              ...
              <div className="flex flex-col mt-10 text-gray-700 dark:text-white">
                ...
                <div className="inline-flex items-center text-sm">
                  <span><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current">
                    <path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path>
                  </svg>
                  </span>
                ...
                <div className="inline-flex items-center text-sm">
                  <span><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span>
                  <span>Easy EMI</span>
                </div>
              </div>

              <p className="ml-2 py-5 text-[13px] dark:text-[#eee] text-body-color">Find the best loan options with flexible terms and competitive rates.</p>              
              <Link href='/products/personal-loans' className="inline-flex items-center font-normal text-sm pl-1 hover:text-primary/90 text-primary">Learn More<span className="pl-1"><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current mt-[3px]"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span></Link>
          ...
          <div className="w-full px-4 md:w-1/3 lg:w-1/4">
            ...
            >
              ...
              <p className="ml-2 py-5 text-[13px] dark:text-[#eee] text-body-color">Find the best loan options with flexible terms and competitive rates.</p>              
              <Link href='/products/business-loans' className="inline-flex items-center font-normal text-sm pl-1 hover:text-primary/90 text-primary">Learn More<span className="pl-1"><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current mt-[3px]"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span></Link>
              <div className="absolute -right-24 -bottom-24">
                 <span className="h-40 w-40 rounded-full bg-primary flex opacity-80 group-hover:h-44 group-hover:w-44 transition-all"></span>
              </div>
            </div>
          ...
          <div className="w-full px-4 md:w-1/3 lg:w-1/4">
            ...
            >
              ...
              <p className="ml-2 py-5 text-[13px] dark:text-[#eee] text-body-color">Find the best loan options with flexible terms and competitive rates.</p>              
              <Link href='/products/auto-loans' className="inline-flex items-center font-normal text-sm pl-1 hover:text-primary/90 text-primary">Learn More<span className="pl-1"><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current mt-[3px]"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span></Link>
              <div className="absolute -right-24 -bottom-24">
                 <span className="h-40 w-40 rounded-full bg-primary flex opacity-80 group-hover:h-44 group-hover:w-44 transition-all"></span>
              </div>
            </div>
          ...
          <div className="w-full px-4 md:w-1/3 lg:w-1/4">
            ...
            >
              ...
              <p className="ml-2 py-5 text-[13px] dark:text-[#eee] text-body-color">Find the best loan options with flexible terms and competitive rates.</p>              
              <Link href='/products/health-loans' className="inline-flex items-center font-normal text-sm pl-1 hover:text-primary/90 text-primary">Learn More<span className="pl-1"><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current mt-[3px]"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span></Link>
              <div className="absolute -right-24 -bottom-24">
                 <span className="h-40 w-40 rounded-full bg-primary flex opacity-80 group-hover:h-44 group-hover:w-44 transition-all"></span>
              </div>
            </div>
          ...
          <div className="w-full px-4 md:w-1/3 lg:w-1/4">
            ...
            >
              ...
              <p className="ml-2 py-5 text-[13px] dark:text-[#eee] text-body-color">Find the best loan options with flexible terms and competitive rates.</p>              
              <Link href='/products/nari-shakti-loans' className="inline-flex items-center font-normal text-sm pl-1 hover:text-primary/90 text-primary">Learn More<span className="pl-1"><svg width="28" height="28" viewBox="0 0 28 28" className="fill-current mt-[3px]"><path d="M16.3333 19.7633V15.0967H5.92666L5.89166 12.7517H16.3333V8.09668L22.1667 13.93L16.3333 19.7633Z"></path></svg></span></Link>
              <div className="absolute -right-24 -bottom-24">
                 <span className="h-40 w-40 rounded-full bg-primary flex opacity-80 group-hover:h-44 group-hover:w-44 transition-all"></span>
              </div>
            </div>
