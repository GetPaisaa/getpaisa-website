...
const Launch = () => {
    ...
    return (
        <div>
            <div className='text-center py-3'><span className='text-primary'>Enter your email to get notify, when app is launched.</span></div>
        <form className="relative border rounded-xl" onSubmit={handleSubmit(onSubmit)}>
            <input
                type="email"
        ...
        <span className={`${success?'block':'hidden'} mt-3 text-start text-primary`}>Subscribed!, Thanks</span>
        </div>
    )
}
