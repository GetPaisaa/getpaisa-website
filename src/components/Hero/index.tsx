          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full lg:w-1/2 px-4">
              <div className="mb-14 lg:mb-0 max-w-4xl">
                <div
                  className="flex font-normal text-white text-xl md:text-[5px] mb-4"
                >
                  <h1 className="leading-[10px] md:leading-[50px]"><span className="text-xl md:text-4xl">Unleashing the Power of Your Financial Future.</span>
                    <div className="rotating-words mt-2 text-2xl md:text-5xl">
                      <span><Link href="/products/personal-loans">Personal Loans</Link></span>
                      <span><Link href="/products/auto-loans">Auto Loans</Link></span>
                      <span><Link href="/products/health-loans">Health Loans</Link></span> 
                      <span><Link href="/products/business-loans">Business Loans</Link></span>
                      <span><Link href="/products/nari-shakti-loans">Nari Shakti Loans</Link></span>
                    </div>
                  </h1>
                </div>
                ...
                <span className="mb-4 text-white text-xl">Attractive Interest Rates Starting From 20%<sup className="text-white">*</sup></span>
            ...
            <div className="w-full lg:w-1/2 px-4">
              <div className="text-center relative z-1 h-[532px] flex items-center justify-center">
                ...
                <span
                  className="absolute -z-1 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[350px] animate-pulse w-full h-[350px] bg-white dark:bg-dark bg-opacity-25 dark:bg-opacity-25 shadow-shape-1 rounded-full"
                >
                </span>
                <span
                  className="absolute -z-1 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[450px] animate-pulse w-full h-[450px] bg-white dark:bg-dark bg-opacity-25 dark:bg-opacity-25 shadow-shape-1 rounded-full"
                >
                </span>
              </div>
            </div>
