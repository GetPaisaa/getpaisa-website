    ...
    return (
        <div>
            <section className='relative'>
                ...
                <div className="bg-gradient-to-r from-gradient-1 to-gradient-2 py-16 rounded-bl-[100px]">
                                ...
                                >
                                    ...
                                    >
                                        <h1>Empowering Your Financials.
                                            <div className="rotating-words mt-2 text-8xl">
                                                <span><Link href="/products/personal-loans">Personal Loans</Link></span>
                                                <span><Link href="/products/personal-loans">Health Loans</Link></span>
                                                <span><Link href="/products/personal-loans">Business Loans</Link></span>
                                                <span><Link href="/products/personal-loans">Nari Shakti Loans</Link></span>
                                            </div>
                                        </h1>
                                    </div>
