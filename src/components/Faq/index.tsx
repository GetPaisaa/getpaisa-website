      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is a GetPaisa app and how can i use it?"
              answer="GetPaisa is a mobile app designed to help users manage their loan-related activities. This may include applying for loans, tracking loan payments."
            />

            <SingleFaq
              question="What types of loans can I apply on GetPaisa App?"
              answer="Loan available at GetPaisa are business loan, personal loan, health loan and nari sakti loan."
            />

            <SingleFaq
              question="How much time it take to get approved for a loan?"
              answer="Approval times can vary based on the lender and the type of loan. Some loans may be approved instantly, while others might take a few days for verification and processing."
            />
          ...
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="You can usually check the status of your loan application by logging into your account on the app and navigating to the application section."
            />
            <SingleFaq
              question="Can I manage my existing loans through the app?"
              answer="Yes, most loan financial apps allow you to manage existing loans by providing features such as viewing loan balances."
            />
            <SingleFaq
              question="How secure is my personal information in the app?"
              answer="Reputable loan financial apps use advanced encryption and security measures to protect your personal and financial information."
            />
          </div>
        </div>
      </div>
