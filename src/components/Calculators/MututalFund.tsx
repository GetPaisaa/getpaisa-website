...
const MututalFund: React.FC = () => {
    ...
    const seriesColumnChart = [Math.floor(principal), Math.floor(interest), Math.floor(principal + interest)];
                    ...
                    <div className="w-full px-4">
                        <div className="max-w-[510px] mx-auto text-center mb-[70px] wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <p className="font-normal text-base text-white">
                                Calculate your Mutual Fund with ease.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="col-span-7">
                                ...
                                <div className="mt-4">
                                    <div className="grid grid-cols-12 items-center">
                                        <span className="text-[14px] md:text-[18px] col-span-5">Principal</span>
                                        <InputNumber
                                            prefix={currency}
                        ...
                        <div className="shadow-sm overflow-hidden my-10">
                            <table className="border-collapse table-Personal w-full text-sm">
                                ...
                                <tbody className="bg-white">
                                    <tr>
                                        <td className="border-slate-100 p-4 text-slate-500 font-normal text-[12px] md:text-[18px] text-left">{currency} {(principal).toLocaleString("en-IN")}</td>
