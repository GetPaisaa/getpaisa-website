...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`ud-header left-0 top-0 z-50 flex w-full items-center ${
          sticky
                    ...
                    {menuData.map((menuItem, index) =>
                      menuItem.path ? (
                        ...
                        <li className="submenu-item group relative" key={index}>
                          ...
                          <div
                            className={`submenu relative rounded-xl shadow-md left-0 top-full w-[250px] bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
                      ...
                      <div className="submenu relative lg:absolute lg:w-[250px] top-full lg:top-[115%] left-0 rounded-lg lg:shadow-lg lg:p-4 lg:opacity-0 lg:invisible group-hover:opacity-100 lg:group-hover:visible lg:group-hover:top-full bg-white dark:bg-black transition-[top] duration-300">
                        <div className="p-2 flex items-center flex-col mb-4">
                          <span className="-mt-2 text-center">
                            ...
                            <span className="text-primary">GetPaisa App</span>
                          </span>
                          <div className="border-2 mt-5 rounded-md border-primary">
                            {" "}
                            <img
                          ...
                          <button className="px-3 py-1.5 flex gap-4 items-center rounded-xl outline outline-2">
                            <div className="w-8">
                              <img
                                ...
                                src="/images1/misc/play.svg"
                              />
                            </div>
                            <div className="text-right">
                              <div className="text-sm font-extrabold hidden md:block">
                                Download on the
                              </div>
