...
const Header = () => {
  ...
  // Navbar toggle
  const [navbarOpen, setNavbarOpen] = useState<any>(false);
  ...
  return (
    <>
      <header
        className={`ud-header left-0 top-0 z-50 flex w-full items-center ${sticky
      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-44 h-12 mt-0 md:-mt-2  max-w-full px-4">
              <Link
                href="/"
            ...
            <div className="flex w-full items-center justify-between px-4">
              <div>
                ...
                >
                  <ul className="block lg:ml-8 lg:flex lg:gap-x-8 xl:ml-14 xl:gap-x-12">
                    {menuData.map((menuItem, index) =>
                      menuItem.path ? (
                          ...
                          {pathUrl !== "/" ? (
                            ...
                            <Link
                              ...
                              className={`ud-menu-scroll flex py-2 text-base lg:inline-flex lg:px-0 lg:py-6 ${sticky
                                ...
                                : "text-body-color dark:text-white lg:text-white hover:text-primary lg:hover:text-white"
                        ...
                        <li className="submenu-item group relative" key={index}>
                          ...
                          <div
                            className={`submenu relative rounded-xl shadow-md left-0 top-full w-[250px] bg-white p-4 transition-[top] duration-300 group-hover:opacity-100 dark:bg-dark-2 lg:invisible lg:absolute lg:top-[110%] lg:block lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${openIndex === index ? "!-left-[25px]" : "hidden"
                              }`}
                          >
                    ...
                    <li className="submenu-item group relative hidden lg:block text-primary dark:text-white">
                      ...
                      <div className="submenu relative lg:absolute lg:w-[250px] top-full lg:top-[115%] left-0 rounded-lg lg:shadow-lg lg:p-4 lg:opacity-0 lg:invisible group-hover:opacity-100 lg:group-hover:visible lg:group-hover:top-full bg-white dark:bg-black transition-[top] duration-300"
                      >
                        <div className='p-2 flex items-center flex-col mb-4'>
                          <span className='-mt-2 text-center'>Scan QR code to download <br /> <span className='text-primary'>GetPaisa App</span></span>
                         <div className="border-2 mt-5 rounded-md border-primary"> <img className='w-36 rounded-md' src='images1/misc/qr-code.svg' /></div>
                        </div>

                        <div className='flex flex-col gap-3'>
                          <button className="px-3 py-1.5 flex gap-4 items-center rounded-xl outline outline-2">
                            <div className="w-8">
                              <img className="h-full w-full" src="/images1/misc/play.svg" />
                            </div>
                          ...
                          <button className="px-3 py-1.5 flex gap-2 items-center rounded-xl outline outline-2">
                            <div className="w-10">
                              <img className="h-full w-full" src="images1/misc/apple.svg" />
                            </div>
                            <div className="text-right">
                              <div className="text-sm font-extrabold hidden md:block">Download on the</div>
              ...
              <div className="items-center justify-end pr-10 sm:pr-16 flex lg:pr-0">
                ...
                <button
                  ...
                  className="flex h-8 w-8 pr-8 items-center justify-center text-body-color duration-300 dark:text-white"
                >
                  <span>
                    <svg
                      viewBox="0 0 16 16"
                ...
                <DownloadNow pathUrl={pathUrl} sticky={sticky} />
                ...
                {/* <div className="hidden sm:block">
                    {pathUrl !== "/" ? (
                      ...
                      <>
                        ...
                        <Link
                          href="#"
                          className={`rounded-lg hover:text-white px-6 py-3 text-base font-medium text-white duration-300 ease-in-out ${
                            sticky
