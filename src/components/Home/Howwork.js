      ...
      <div className="container">
        <div className="flex justify-center -mx-4">
          <div className="w-full px-4">
            ...
            >
              ...
              Creating "How it Works" content involves explaining the steps, processes, 
              or functionalities of a product, service, or system in a clear and concise manner. 
              Here’s a general outline for crafting "How it Works" content:
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div
              className="mb-12 mx-auto max-w-[310px] text-center group wow fadeInUp"
              data-wow-delay=".2s"
            >
              <div
                className="w-20 h-20 mx-auto rounded-3xl bg-primary bg-opacity-5 flex items-center justify-center text-primary group-hover:bg-opacity-100 group-hover:text-white transition-all mb-5"
              >
                <svg
                  width="42"
                  height="43"
                ...
                >
                  <path
                    d="M3.5 21.3843H7V30.1343H35V21.3843H38.5V30.1343C38.5 32.0768 36.9425 33.6343 35 33.6343H7C5.075 33.6343 3.5 32.0768 3.5 30.1343V21.3843ZM21 26.6343L30.7125 17.0793L28.2275 14.6118L22.75 20.0718V3.88428H19.25V20.0718L13.79 14.6118L11.305 17.0968L21 26.6343Z"
                  />
                </svg>
              </div>
              <h3
                className="font-normal text-xl sm:text-2xl md:text-xl lg:text-2xl text-black dark:text-white mb-4"
              >
                Download for Free
              </h3>
              <p className="font-normal text-base text-body-color">
              Download GetPaisa app for free from play stores.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <p className="font-normal text-base text-body-color">
              Open free account on GetPaisa app using social login and other options.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            >
              ...
              <p className="font-normal text-base text-body-color">
              Explore the features regarding loans and other features.
              </p>
            </div>
          </div>
        </div>
