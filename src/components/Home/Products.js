      ...
      <div className="container">
        ...
        <div className="flex flex-wrap -mx-4">
          <div className="w-full md:w-1/3 xl:w-1/4 px-4">
            <div className="bg-white shadow-md p-10 sm:p-12 md:p-10 lg:p-12 xl:p-10 2xl:p-12 rounded-[20px] shadow-award mb-8 cursor-pointer hover:scale-105 transition-all">
              <div className="flex items-center mb-6">
                <span className="pr-[10px]">
                  ...
                  >
                    <circle cx="16" cy="16" r="16" fill="#0013A3" />
                    <path
          ...
          <div className="w-full md:w-1/3 xl:w-1/4 px-4">
            <div
              className="bg-white shadow-md p-10 sm:p-12 md:p-10 lg:p-12 xl:p-10 2xl:p-12 rounded-[20px] shadow-award mb-8 cursor-pointer hover:scale-105 transition-all"
            >
              <div className="flex items-center mb-6">
                <span className="pr-[10px]">
                  <svg
