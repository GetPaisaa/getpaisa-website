...
const Contact = () => {
  ...
  return (
    <div>
      ...
      <section id="contact" className="py-[100px] overflow-hidden">
        <div className="container">
            ...
            <div className="w-full px-4">
              ...
              >
                ...
                <p className="font-normal text-base text-body-color">
                  Fill up the below form to get help regarding loans, services , terms and condition.
                </p>
              </div>
            </div>
          </div>
          ...
          <div
            className="max-w-[770px] mx-auto shadow-faq rounded-2xl relative bg-white dark:bg-dark z-10 wow fadeInUp"
            data-wow-delay=".3s"
          >
            <div
              className="py-10 px-8 sm:p-[70px] bg-white dark:bg-black rounded-2xl border border-gradient-1 dark:border-dark"
            >
                ...
                <div className="flex flex-wrap -mx-4">
                  <div className="w-full md:w-1/2 px-4">
                    <div className="mb-6">
                      <label
                        for=""
                        className="block font-normal text-base text-black dark:text-white mb-3"
                      >
                        First Name
                      </label>
                      <input
                        ...
                        className="w-full font-normal text-sm text-body-color py-[14px] px-5 rounded-lg border border-gradient-1 dark:border-dark bg-transparent dark:bg-dark outline-none placeholder-body-color focus-visible:shadow-none focus:border-primary"
                      />
                    </div>
                  </div>
                  <div className="w-full md:w-1/2 px-4">
                  ...
                  <div className="w-full px-4">
                    <div className="mb-10">
                      ...
                      <textarea
                        ...
                        className="w-full font-normal text-sm text-body-color py-[14px] px-5 rounded-lg border border-gradient-1 dark:border-dark bg-transparent dark:bg-dark outline-none placeholder-body-color focus-visible:shadow-none focus:border-primary resize-none"
                      ></textarea>
                    </div>
                  </div>
                  <div className="w-full px-4">
                    <div className="text-center">
                      <button
                        className="font-normal text-base text-white bg-primary rounded-xl py-3 px-10 text-center hover:shadow-primary-hover"
                      >
            ...
            <div>
              <span className="absolute bottom-8 -left-14 -z-1">
                <svg
                  width="126"
                  height="156"
                  viewBox="0 0 126 156"
              ...
              <span className="absolute -top-8 -right-14 -z-1">
                <svg
                  width="161"
                  height="189"
                  viewBox="0 0 161 189"
