            ...
            <div className="mb-10 w-full">
              ...
              <div className="-mx-3 flex items-center">
                ...
                <a
                  ...
                  className="px-3 text-gray-7 hover:text-white"
                >
                  <img className="h-6" src="images1/misc/youtube.svg"/>
                </a>
          ...
          <div className="w-full px-4 md:w-2/3 lg:w-6/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              <ul>
                ...
                <li>
                  <Link
                    href="https://getpaisa-website.s3.ap-south-1.amazonaws.com/PropkarNBFC.pdf"
                    className="mb-3 inline-block text-base text-gray-7 focus:text-primary hover:text-primary"
                  >
                  RBI Certificate
                  </Link>
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex text-white items-center justify-center md:justify-start">
                Copyright  © 2024
                </div>
              </div>
            </div>
